...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'sproc.assemble': { 'sproc.assemble.distilled_data_from_zip': ('assemble.html#distilled_data_from_zip', 'sproc/assemble.py'),
            ...
            'sproc.core': { 'sproc.core.cli_dl': ('core.html#cli_dl', 'sproc/core.py'),
                            'sproc.core.cli_extend_parquet_with_zip': ('core.html#cli_extend_parquet_with_zip', 'sproc/core.py'),
                            'sproc.core.cli_read_single_zip': ('core.html#cli_read_single_zip', 'sproc/core.py'),
                            ...
                            'sproc.core.dl': ('core.html#dl', 'sproc/core.py'),
            ...
            'sproc.download': { 'sproc.download.file': ('download.html#file', 'sproc/download.py'),
                                ...
                                'sproc.download.yaml_to_dict': ('download.html#yaml_to_dict', 'sproc/download.py')},
            ...
            'sproc.hier': { 'sproc.hier.columns_containing': ('hierarchical.html#columns_containing', 'sproc/hier.py'),
                            'sproc.hier.data_scheme_ok': ('hierarchical.html#data_scheme_ok', 'sproc/hier.py'),
                            ...
                            'sproc.hier.is_column_multiindexed': ('hierarchical.html#is_column_multiindexed', 'sproc/hier.py'),
            ...
            'sproc.io': { 'sproc.io.File': ('io.html#file', 'sproc/io.py'),
                          ...
                          'sproc.io.cast_multivalued_series_to_common_type': ( 'io.html#cast_multivalued_series_to_common_type',
                                                                               'sproc/io.py'),
                          'sproc.io.cast_to_list_if_not_already': ('io.html#cast_to_list_if_not_already', 'sproc/io.py'),
